...
class CustomUserCreationForm(UserCreationForm):
    email = forms.EmailField(required=True, max_length=254, widget=forms.TextInput(attrs={
...
class CustomUserUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = [
            'first_name', 'last_name', 'email', 'phone', 'company', 'address1', 'address2', 'city', 'province', 'postal_code'
        ]
        widgets = {
